...
const ASSETS_CALLBACK = "https://ashes-assets.vercel.app/ashes-callback";
...
function allowedReturnUrl(value) {
  return [SAYIT_CALLBACK, CONNECT_CALLBACK, ROBOLAB_CALLBACK, ASSETS_CALLBACK].includes(value) ? value : "";
}
