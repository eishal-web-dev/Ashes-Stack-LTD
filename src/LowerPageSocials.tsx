  ...
  useEffect(()=>{
    ...
    wrap.innerHTML=`
      ...
      <div class="social-cluster" aria-label="Ashes social links">
        ...
        <div class="social-slot social-x">
        ...
        <div class="social-slot social-linkedin">
          <a class="social-shape shape-3" href="https://www.linkedin.com/in/eishal-9679a42b9?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noreferrer" aria-label="LinkedIn — Eishal">${linkedinIcon}</a>
        ...
        <div class="social-slot social-tiktok">
          <a class="social-shape shape-4" href="https://www.tiktok.com/@eishal_4a?_r=1&_t=ZS-98ygYWaw3L3" target="_blank" rel="noreferrer" aria-label="TikTok — @eishal_4a">${tiktokIcon}</a>
        ...
        <div class="social-slot social-whatsapp">
          <a class="social-shape shape-5" href="https://wa.me/923305315817?text=Hi%2C%20I%20found%20you%20through%20Ashes." target="_blank" rel="noreferrer" aria-label="WhatsApp — 0330 5315817">${whatsappIcon}</a>
