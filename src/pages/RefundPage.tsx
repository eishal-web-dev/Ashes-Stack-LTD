...
export default function RefundPage() {
  useSEO({ title: 'Refund Policy | Ashes Stack', description: 'Refund and cancellation policy for Ashes Brain subscriptions processed by Lemon Squeezy.', path: '/refund' });
  return (
    <main style={{ minHeight: '100vh', background: '#080808', color: '#f3f3ef', padding: '72px 24px', fontFamily: 'Inter,system-ui,sans-serif' }}>
      <article style={{ maxWidth: 780, margin: '0 auto' }}>
        ...
        <p style={{ color: '#aaa', lineHeight: 1.75 }}>This policy applies to paid Ashes Brain subscriptions purchased through our checkout. Lemon Squeezy acts as the merchant of record and processes subscription payments and approved refunds.</p>

        <h2>First subscription payment</h2>
        <p>You may request a refund of your first subscription payment within 14 days of purchase. Contact us using the email address below and include the email used for your Ashes Brain account and your Lemon Squeezy order or receipt number.</p>
        ...
        <p>Approved refunds are returned through Lemon Squeezy to the original payment method. Bank and card processing times vary and are outside Ashes Stack's control. This policy does not limit any mandatory consumer rights that apply to you.</p>

        <h2>Request a refund</h2>
        <p>Email <a href="mailto:contact@ashesstack.cloud" style={{ color: '#fff' }}>contact@ashesstack.cloud</a> with your account email, Lemon Squeezy order or receipt number, purchase date and a short explanation of the request.</p>
